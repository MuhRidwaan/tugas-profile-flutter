            ...
            children: [
              ...
              Padding(
                ...
                child: Card(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        _infoRow(Icons.badge, 'NIM', '0112523005'),
                        const Divider(),
                        _infoRow(Icons.school, 'Status',
                            'Mahasiswa Teknik Informatika'),
                        const Divider(),
                        _infoRow(
                            Icons.email, 'Email', 'alfannurhasani@gmail.com'),
                      ],
                    ),
                  ),
                ),
              ...
              Row(
                ...
                children: [
                  _socialBtn(
                      'LinkedIn',
                      'https://www.linkedin.com/in/alfan-nurkhasani-a407032a8/',
                      const Color(0xFF0077B5)),
                  const SizedBox(width: 15),
                  _socialBtn(
                      'Instagram',
                      'https://www.instagram.com/call_fannnn?igsh=OXBndGVna2p0Y2lx',
