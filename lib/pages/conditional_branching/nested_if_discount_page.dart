...
/// Page demonstrating Nested IF through tiered discount calculation
class NestedIfDiscountPage extends StatefulWidget {
  const NestedIfDiscountPage({super.key});

  @override
  State<NestedIfDiscountPage> createState() => _NestedIfDiscountPageState();
}

class _NestedIfDiscountPageState extends State<NestedIfDiscountPage> {
  // Controller
  ...
  /// Calculates discount using nested IF statements
  void _calculateDiscount() {
    ...
    // Nested IF logic for tier determination
    if (amount >= 1500000) {
      rate = 0.30;
    } else {
      if (amount >= 1000000) {
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                ConditionalBranchingStrings.nestedIfTitle,
              ...
              const Text(
                'Hitung diskon bertingkat menggunakan Nested IF',
                textAlign: TextAlign.center,
                style: TextStyle(
                  fontSize: 14,
