...
class ProfileNia extends StatefulWidget {
  const ProfileNia({super.key});

  @override
  State<ProfileNia> createState() => _ProfileNiaState();
}

class _ProfileNiaState extends State<ProfileNia> {
  ...
  void initState() {
    ...
    _controller = VideoPlayerController.asset(
      'assets/videos/nia_introduction.mp4',
    )..initialize().then((_) {
        setState(() {});
                    ...
                    CircleAvatar(
                      ...
                      child: CircleAvatar(
                        ...
                        backgroundImage: _imageFile != null
                            ...
                            : const AssetImage('assets/images/nia.jpeg')
                                as ImageProvider,
                      ),
                    ),
                    Positioned(
